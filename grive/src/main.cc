...
int Main( int argc, char **argv )
{
	...
	desc.add_options()
		...
		( "sbout,b",	"Produce about message" )
		( "info,i",		"Produce info message with details of storage" )
		( "version,v",	"Display Grive version" )
		( "auth,a",		"Request authorization token" )
		( "kdrive,k",	"Enable kDrive integration" )
		( "daemon,e",	"Run application in background as daemonin" )
		( "inotify,n",	"Enable iNotify" )
		( "plocal,l",	"Sync local each period" )
// TODO: Add processing of period parameter
//		( "period,t",	po::value<std::int>(), "Seconds of period")
